...
<div class="admin-shell">
    <div class="card content-panel">
        <div class="page-head">
            ...
            <div class="actions">
                <a href="<?= app_relative_url('/') ?>" target="_blank" rel="noopener" class="btn btn-outline">Preview Landing Page</a>
                <a href="<?= app_relative_url('admin/site-settings') ?>" class="btn btn-primary">Edit Landing Page</a>
            </div>
        </div>
        <div class="grid-4">
            <div class="stat">
